...
class DataTambahanAdapter(private val listtambahan: ArrayList<ModelTambahan>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvCardTambahanId.text = item.idTambahan ?: "Tidak ada ID"
        holder.tvnamatambahan.text = item.namaTambahan ?: "Nama tidak tersedia"
        holder.tvhargatambahan.text = item.hargaTambahan ?: "Harga tidak tersedia"
